...
<body id="page-top">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="tombolswitch">
                                <a class="btn btn-secondary" href="./tumbuh-1.php" role="button">Hari</a>
                                <a class="btn btn-primary active" href="./tumbuh-2.php" role="button">Minggu</a>
                            </div>
                            <div id="tumbuh-2">
                                <?php
                                include 'koneksi.php';
                                ...
                                while ($i <= 30) {
                                    while ($p <= $i) {
                                        if ($p < 10) {
                                            $sql = "SELECT sum(total) * 0.3 as profit FROM transaksi WHERE tgltr = \"2020-06-0$p\"";
                                        } else {
                                            $sql = "SELECT sum(total) * 0.3 as profit FROM transaksi WHERE tgltr = \"2020-06-$p\"";
                                        }
                            ...
                            <label class="mt-4">
                                <p>
                                    <i>Ket : Profit bersih minimal 30% dari total penjualan perminggu</i>
                                </p>
                            </label>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        Highcharts.chart('tumbuh-2', {
            chart: {
                type: 'line'
            },
            title: {
                text: 'Profit bersih/minggu dalam 1 bulan'
            },
            xAxis: {
