                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <?php
                                    include 'koneksi.php';
                                    $sqlsearch = "select d.kodetr,d.kodemenu,t.tgltr,d.nama,d.jumlah,d.total from detail d join transaksi t on d.kodetr=t.kodetr";
                                    $hasil = mysqli_query($host, $sqlsearch);
                                    if (mysqli_num_rows($hasil) > 0) {
                                        while ($Data = mysqli_fetch_assoc($hasil)) { ?>
                                            <tr>
                                                <td><?php echo $Data["kodetr"] ?> <input type="hidden" name="kode" value="<?php echo $Data["kodetr"] ?>"></td>
                                                <td><?php echo $Data["kodemenu"] ?> <input type="hidden" name="kode" value="<?php echo $Data["kodemenu"] ?>"></td>
                                                <td><?php echo $Data["tgltr"] ?> <input type="hidden" name="kode" value="<?php echo $Data["tgltr"] ?>"></td>
                                                <td><?php echo $Data["nama"] ?> <input type="hidden" name="nama" value="<?php echo $Data["nama"] ?>"></td>
                                                <td><?php echo $Data["jumlah"] ?> <input type="hidden" name="satuan" value="<?php echo $Data["jumlah"] ?>"></td>
                                                <td><?php echo $Data["total"] ?> <input type="hidden" name="total" value="<?php echo $Data["total"] ?>"></td>
